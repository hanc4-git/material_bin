...
{  
  ...
  // Detector parameters
  //
  G4double detector_sizeX = 100*mm, detector_sizeY = 100*mm, detector_sizeZ = 100*mm;
  ...
  G4Element* elI  = new G4Element("Iodine" , "I", 53., 126.904*g/mole);

  // define simple materials
  // define a material from elements.   case: chemical molecule
  G4Material* detector_mat = new G4Material("Semiconductor", 4.58*g/cm3, 3);
  detector_mat->AddElement(elCs, 3);
  detector_mat->AddElement(elBi, 2);
  detector_mat->AddElement(elI , 9);
